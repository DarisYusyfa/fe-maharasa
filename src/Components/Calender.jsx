...
export const Calender = () => {
  ...
  return (
    <div className="relative shadow-2xl bg-slate-400 rounded-lg px-10 pt-8 pb-8 " data-aos="fade-up">
      <h2 className="text-lg font-semibold mb-4" data-aos="fade-down">RUMAH MAKAN MAHARASA</h2>
      ...
      {selectedDate && <p className="mt-4" data-aos="fade-up">Selected Date: {selectedDate.toLocaleDateString()}</p>}
      <p className="mt-2" data-aos="fade-up">Jumlah Tamu: {numberOfPeople}</p>
      {selectedTime && <p className="mt-2" data-aos="fade-up">Jam Kedatangan: {selectedTime}</p>}
