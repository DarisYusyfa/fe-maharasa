    ...
    <footer id="Contact" className="bg-black text-white relative">
      <section id="contact" className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        ...
        <div className="mt-6 sm:mt-0 sm:ml-auto w-full max-w-xs">
          <h2 className="mb-2 text-sm font-semibold text-black uppercase ">Kritik dan Saran</h2>
          <form>
            <textarea className="w-full p-2 text-sm text-black dark:text-gray-900 bg-white  border rounded" placeholder="Masukkan kritik dan saran Anda di sini..." rows="3"></textarea>
            <button type="submit" className="mt-2 px-4 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 dark:hover:bg-blue-800">
              Kirim
            </button>
          </form>
        </div>
