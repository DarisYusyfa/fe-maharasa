        ...
        <div className="bg-blue-400 p-6 rounded-xl shadow-xl w-full md:w-2/3 lg:w-1/3 border border-gray-300">
          ...
          <form className="mt-8 space-y-6" action="#">
            ...
            <div className="flex justify-center">
              <button className="w-full md:w-52 px-3 py-2 text-base font-bold shadow-md bg-primary hover:bg-secondary text-white bg-black rounded-lg focus:ring-4 focus:ring-blue-300">
                Login
              </button>
            </div>
          </form>
