...
import { FaRegCalendarAlt, FaRegClock, FaUser, FaClipboardList, FaChair } from 'react-icons/fa';
...
export const Order = () => {
  ...
  const handleConfirm = async (e) => {
    ...
    if (!customerDetails.name || !customerDetails.email || !customerDetails.phone || !eventDetails.date || !eventDetails.time || !eventDetails.attendees) {
    ...
    const reservationData = {
      ...
      desk_id: eventDetails.table, // Ubah deskId menjadi eventDetails.table
    };

    console.log(reservationData);

    try {
      const response = await axios.post(`${import.meta.env.VITE_API_BASE_URL}reservation/reservation`, reservationData);
      ...
      <form onSubmit={handleConfirm}>
        <div className="mb-6 p-4 bg-gray-100 rounded-lg" data-aos="fade-right">
          ...
          <div className="mb-4">
            ...
            <input type="text" id="name" name="name" className="w-full border-gray-300 rounded-md shadow-sm" value={customerDetails.name} onChange={(e) => setCustomerDetails({ ...customerDetails, name: e.target.value })} />
          </div>
          <div className="mb-4">
            <label className="block text-gray-700 mb-2" htmlFor="email">
              Email
            </label>
            <input type="email" id="email" name="email" className="w-full border-gray-300 rounded-md shadow-sm" value={customerDetails.email} onChange={(e) => setCustomerDetails({ ...customerDetails, email: e.target.value })} />
          </div>
          <div className="mb-4">
            ...
            <div className="flex items-center">
              ...
              <input type="tel" id="phone" name="phone" className="w-full border-gray-300 rounded-md shadow-sm" value={customerDetails.phone} onChange={(e) => setCustomerDetails({ ...customerDetails, phone: e.target.value })} />
            </div>
          </div>
        </div>
        ...
        <div className="mb-6 p-4 bg-gray-100 rounded-lg" data-aos="fade-left">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-center mb-2 border-t-2" data-aos="fade-up" data-aos-delay="400">
              <FaChair className="mr-2" />
              <span className="text-gray-700">Meja {eventDetails.table}</span>
            </div>
            <div className="flex items-center mb-2 border-t-2 border-b-2" data-aos="fade-up" data-aos-delay="500">
          ...
          <div className="mb-4">
            ...
            <div className="flex items-start mt-2" data-aos="fade-up" data-aos-delay="700">
        ...
        <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600" data-aos="fade-up" data-aos-delay="800">
          Konfirmasi
        </button>
      </form>
    </div>
