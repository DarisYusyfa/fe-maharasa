        ...
        >
          ...
          <form className="mt-8 space-y-6" onSubmit={submit}>
            ...
            <div className="flex justify-center flex-col items-center">
              <button type="submit" className="w-full md:w-52 px-3 py-2 mb-1 text-base font-bold text-center shadow-md bg-primary hover:bg-secondary text-white bg-black rounded-lg focus:ring-4 focus:ring-blue-300 mx-auto">
                Login
              </button>
              <button
                type="button"
